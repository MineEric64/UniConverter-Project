...
#End Region
    ...
    Private Sub PlaykeySound(sender As Object)
        Try
            ...
            For Each strLine As String In MainProject.SplitbyLine(ksTmpTXT)
    ...
    Private Sub KeySound_ShowLayout_DoWork(sender As Object, e As DoWorkEventArgs) Handles keySound_ShowLayout.DoWork
        Try
            ...
            If String.IsNullOrWhiteSpace(ksTmpTXT) = False Then
                For Each strLine As String In MainProject.SplitbyLine(ksTmpTXT) 'String을 각 라인마다 자름.
                    If String.IsNullOrWhiteSpace(strLine) = False Then
                        ...
                        If CInt(Mid(strLine, 1, 1)) = keySound_CChain Then
                            ...
                            keySound_DifM = Cntstr(ksTmpTXT, UniPack_SelectedChain & " " & UniPack_X & " " & UniPack_Y & " ")
