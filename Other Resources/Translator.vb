...
#Region "Translator New 선언"
    ...
    Public Sub New(ByVal Language As String, ByVal IsDeveloperMode As Boolean)
        lang = Language
        IsDM = IsDeveloperMode
    End Sub

    Public Function GetTranslator(ByVal Language As String) As Translator
        Return New Translator(Language)
    End Function

    Public Function GetTranslator(ByVal Language As String, IsDeveloperMode As Boolean) As Translator
        Return New Translator(Language, IsDeveloperMode)
    End Function
#End Region
    Public Function GetLanguage(ByVal CultureInfo As CultureInfo) As String
        ...
        Select Case lang
            ...
            Case "Korean"
                ...
                With MainProject
                    ...
                    .MIDIn_Test.Text = "미디 인풋 테스트"
                    .LoadButton.Text = "불러오기"
                    .ConnectButton.Text = "연결"
                    .MIDIStat.Text = "미디 상태:"
                    .MIDIStatIn.Text = "미디 인풋: 연결 안됨"
                    .MIDIStatOut.Text = "미디 아웃풋: 연결 안됨"

                    'MainProject 폼
                    If IsDM = False Then
                        .Text = "유니컨버터 베타 4"
                    Else
                        .Text = "유니컨버터 베타 4 (제작자 모드)"
                    End If
